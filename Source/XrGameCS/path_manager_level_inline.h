...
TEMPLATE_SPECIALIZATION
IC	void CLevelPathManager::begin			(const _index_type &vertex_id, inherited::const_iterator &begin, inherited::const_iterator &end)
{
	this->graph->begin			(best_node,begin,end);
}

TEMPLATE_SPECIALIZATION
IC	const _index_type CLevelPathManager::get_value		(inherited::const_iterator &i) const
{
