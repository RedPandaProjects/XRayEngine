...
void CBloodsuckerStateAttackAbstract::update_invisibility()
{
	...
	{
		if ( Device->dwTimeGlobal > m_time_stop_invis + this->object->get_invisibility_activate_delay() )
		{
			...
			else if ( this->object->EnemyMan.get_enemy()->Position().distance_to(this->object->Position()) > 
