...
public:
	...
	IC		void		begin			(const _index_type &vertex_id, inherited::const_iterator &begin, inherited::const_iterator &end);
	IC		const _index_type get_value	(inherited::const_iterator &i) const;
};
