...
struct CDataStorageBucketList {
	...
	template <typename _data_storage, template <typename _T> class _vertex1 = CEmptyClassTemplate>
	class CDataStorage : public CDataStorageDoubleLinkedList<false>::CDataStorage<typename _data_storage, BucketList<_vertex1>::_vertex>
	{
	public:
		typedef typename CDataStorageDoubleLinkedList<false>::CDataStorage<
			_data_storage,
			BucketList<_vertex1>::_vertex
		>											inherited;
