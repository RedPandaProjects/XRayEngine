...
//////////////////////////////////////////////////////////////////////////
// global variables
ENGINE_API	IRBMKEngine* g_Engine = NULL;
...
bool IRBMKEngine::IsRunningGame		()
{
	return g_pGameLevel!=nullptr;
}

shared_str IRBMKEngine::GetGameVersion()
{
	xr_string Version = "";
...
void IRBMKEngine::OnEvent(EVENT E, u64 P1, u64 P2)
{
	if (E==eQuit)
	{
		Exit();
...
IRBMKLevelToBlueprint* IRBMKEngine::GetLevelScript()
{
	if(g_pGameLevel)
	{
		return g_pGameLevel;
...
void IRBMKEngine::InitInput()
{
	BOOL bCaptureInput = !strstr(Core.Params, "-i");
	VERIFY(GXRayInput);
}

void IRBMKEngine::InitConsole()
{
...
void IRBMKEngine::execUserScript()
{
...
void IRBMKEngine::destroySettings()
{
...
void IRBMKEngine::destroyConsole()
{
...
void IRBMKEngine::destroyEngine()
{
	Engine->Destroy();
