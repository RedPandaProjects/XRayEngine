...
enum class EXRaySpawnPropertiesType
{
	None,
...
public:
	...
	virtual ISE_ALifeInventoryItem*		CastALifeInventoryItem		()	{	return 0;	}
	virtual ISE_ALifeTraderAbstract*	CastALifeTraderAbstract		()	{	return 0;	}
	virtual EXRaySpawnPropertiesType	GetPropertiesType			()	{	return EXRaySpawnPropertiesType::None; }
	virtual void*						QueryPropertiesInterface	(EXRaySpawnPropertiesType InType)	{	return nullptr;}
