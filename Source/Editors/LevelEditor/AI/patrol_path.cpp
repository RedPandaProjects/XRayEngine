...
CPatrolPath	&CPatrolPath::load_raw	(const ILevelGraph *level_graph, const CGameLevelCrossTable *cross, const IGameGraph *game_graph, IReader &stream)
{
...
CPatrolPath& CPatrolPath::load_editor(const ILevelGraph* level_graph, const CGameLevelCrossTable* cross, const IGameGraph* game_graph, CWayObject* object)
{
