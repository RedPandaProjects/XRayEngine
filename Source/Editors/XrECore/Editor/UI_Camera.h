...
public:
    ...
    const Fvector&	GetRight	() const {return m_CamMat.get_i();}
    const Fvector&	GetNormal	() const {return m_CamMat.get_j();}
    const Fvector&	GetDirection() const {return m_CamMat.get_k();}
