...
{
	if( m_eScopeStatus == CSE_ALifeItemWeapon::EWeaponAddonStatus::eAddonAttachable &&
	   0 != (m_flagsAddOnState&CSE_ALifeItemWeapon::eWeaponAddonScope) &&
	   (m_sScopeName	== item_section_name))
       return true;
	else if(m_eSilencerStatus == CSE_ALifeItemWeapon::EWeaponAddonStatus::eAddonAttachable &&
	   0 != (m_flagsAddOnState&CSE_ALifeItemWeapon::eWeaponAddonSilencer) &&
	   (m_sSilencerName == item_section_name))
       return true;
	else if(m_eGrenadeLauncherStatus == CSE_ALifeItemWeapon::EWeaponAddonStatus::eAddonAttachable &&
...
bool CWeaponMagazined::Attach(PIItem pIItem, bool b_send_event)
{
	...
	if(pScope &&
	   m_eScopeStatus == CSE_ALifeItemWeapon::EWeaponAddonStatus::eAddonAttachable &&
	   (m_flagsAddOnState&CSE_ALifeItemWeapon::eWeaponAddonScope) == 0 &&
	   (m_sScopeName == pIItem->object().cNameSect()))
	{
	   ...
	   m_eSilencerStatus == CSE_ALifeItemWeapon::EWeaponAddonStatus::eAddonAttachable &&
	   (m_flagsAddOnState&CSE_ALifeItemWeapon::eWeaponAddonSilencer) == 0 &&
	   (m_sSilencerName == pIItem->object().cNameSect()))
	{
	   ...
	   m_eGrenadeLauncherStatus == CSE_ALifeItemWeapon::EWeaponAddonStatus::eAddonAttachable &&
	   (m_flagsAddOnState&CSE_ALifeItemWeapon::eWeaponAddonGrenadeLauncher) == 0 &&
	   (m_sGrenadeLauncherName == pIItem->object().cNameSect()))
	{
