#include "pch.h"
#include "XRayBlenderHudFont.h"

XRayBlenderHudFont::XRayBlenderHudFont()
{
}
...
void XRayBlenderHudFont::InitializeGraphics()
{
	...
	CreatePipeline(0,0, PipelineDescription, "hud\\notransform_tl", "hud\\font", SVD_TL);
}

void XRayBlenderHudFont::Compile(XRayShaderElement& shader)
{
	if (IDSlot == 0)
	{
		if (IDShader == 0)
