...
protected:
	...
	void					_Render_soft(u32 FVF,BearFactoryPointer<BearRHI::BearRHIVertexBuffer>&VertexBuffer, BearFactoryPointer<BearRHI::BearRHIIndexBuffer>& IdexBuffer, size_t CountVertex, size_t OffsetIndex, size_t CountIndex);
	void					_Render(u32 FVF, BearFactoryPointer<BearRHI::BearRHIVertexBuffer>& VertexBuffer, BearFactoryPointer<BearRHI::BearRHIIndexBuffer>& IdexBuffer, size_t CountVertex, size_t OffsetIndex, size_t CountIndex, BearFactoryPointer<BearRHI::BearRHIUniformBuffer>& UniformBuffer);
	virtual void			_Load_hw(XRayFVisual& V, void* data) = 0;
	virtual void			_CollectBoneFaces(XRayFVisual* V, size_t iBase, size_t iCount) = 0;
	...
	virtual BOOL			_PickBone(IKinematics::pick_result& r, float range, const Fvector& S, const Fvector& D, XRayFVisual* V, u16 bone_id, size_t iBase, size_t iCount) = 0;
public:
