...
void dxFontRender::Initialize(LPCSTR font, float size)
{
}

float dxFontRender::GetTextSize(LPCSTR s)
{
	return 0;
}

float dxFontRender::GetTextSize(const wide_char* wsStr)
{
	return 0;
}

float dxFontRender::GetTextSize(const char cChar)
{
	return 0;
}
...
//
//				if ( PS.align )
//					fSize = owner.IsMultibyte() ? owner.GetTextSize( wsStr ) : owner.GetTextSize( PS.string );
//
//				switch ( PS.align )
//				{
