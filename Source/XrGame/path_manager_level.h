...
public:
	...
	IC		void		begin			(const _index_type &vertex_id, const _Graph::const_iterator&begin, const _Graph::const_iterator& end);
	IC		const _index_type get_value	(const _Graph::const_iterator&i) const;
};
