...
// heli weapons
	...
	static void 		_BCL		BoneMGunCallbackX		(IBoneInstance *B);
	static void			_BCL		BoneMGunCallbackY		(IBoneInstance *B);
...
// sound, light, particles...
	FRBMKSoundSourceRef						m_engineSound;
	FRBMKSoundSourceRef						m_brokenSound;
//	FRBMKSoundSourceRef						m_explodeSound;
