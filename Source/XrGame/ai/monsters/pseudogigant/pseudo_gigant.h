...
private:
	...
	FRBMKSoundSourceRef		m_sound_threaten_hit;		// звук, который играется в голове у актера
	FRBMKSoundSourceRef		m_sound_start_threaten;		// звук, который играется в голове у актера
